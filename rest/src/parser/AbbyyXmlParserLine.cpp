...
////////////////////////////////////////////////////////////////////////////////
LinePtr AbbyyXmlParserLine::line(int id) const {
...
////////////////////////////////////////////////////////////////////////////////
std::wstring AbbyyXmlParserLine::wstring() const {
...
////////////////////////////////////////////////////////////////////////////////
std::string AbbyyXmlParserLine::string() const {
  std::string res;
...
////////////////////////////////////////////////////////////////////////////////
void AbbyyXmlParserLine::erase(size_t pos) {
...
////////////////////////////////////////////////////////////////////////////////
void AbbyyXmlParserLine::set(size_t pos, wchar_t c) {
...
void AbbyyXmlParserLine::init() {
  ...
  for (const auto &char_param : char_params) {
    ...
    // abbyy's charConfidence is from -1 to 100 (issue-13)
    auto conf = node.attribute("charConfidence").as_double() / 100.0;
    if (conf < 0) { // fix abbyy charConfidence < 0 (issue-13)
      conf = 0;
    } else if (conf > 1.0) {
      conf = 1;
    }
...
////////////////////////////////////////////////////////////////////////////////
Box AbbyyXmlParserLine::get_box(const Node &node) {
...
////////////////////////////////////////////////////////////////////////////////
void AbbyyXmlParserLine::set_box(const Box &box, Node &node) {
...
////////////////////////////////////////////////////////////////////////////////
wchar_t AbbyyXmlParserLine::get_char(const Node &node) {
...
////////////////////////////////////////////////////////////////////////////////
void AbbyyXmlParserLine::set_char(wchar_t c, Node &node) {
...
////////////////////////////////////////////////////////////////////////////////
AbbyyXmlParserLine::Char AbbyyXmlParserLine::char_before(Char &c, wchar_t cc) {
