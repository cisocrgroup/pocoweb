...
<%if (user.admin) {%>
	...
	<div class="btn-group float-right">
		<a  class="btn btn-outline-primary blue hover"href="rest/pool/global?auth=<%-auth%>" download="global-pool.zip">
		<i class="fas fa-cloud-download-alt"></i> Download project pool</a>
		<a class="btn btn-outline-primary blue hover"  href="rest/pool/global?auth=<%-auth%>" download="user-pool.zip">
