...
////////////////////////////////////////////////////////////////////////////////
bool Session::has_expired() const noexcept {
...
////////////////////////////////////////////////////////////////////////////////
void Session::set_cookies(crow::response& response) const noexcept {
...
void pcw::set_cookie(crow::response& response, const std::string& key,
	...
	os << key << "=" << val << "; path=/"
	   << "; expires=" << stime << "; domain=pocoweb.cis.lmu.de"
	   << ";";
	response.add_header(SetCookie, os.str());
}

////////////////////////////////////////////////////////////////////////////////
boost::optional<std::string> pcw::get_cookie(const crow::request& request,
	...
	for (auto i = range.first; i != range.second; ++i) {
		CROW_LOG_DEBUG << "(get_cookie) searching: " << i->first << ": "
			       << i->second;
