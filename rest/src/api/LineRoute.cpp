...
////////////////////////////////////////////////////////////////////////////////
Route::Response
LineRoute::impl(HttpGet, const Request& req, int pid, int pageid, int lid) const
{
...
////////////////////////////////////////////////////////////////////////////////
void
LineRoute::correct(DbLine& line, const std::string& correction)
{
  WagnerFischer wf;
  const auto slice = line.slice();
  wf.set_gt(correction);
  wf.set_ocr(slice.cor());
  const auto lev = wf();
...
////////////////////////////////////////////////////////////////////////////////
void
LineRoute::correct(DbLine& line, const std::string& correction, int b, int len)
{
...
////////////////////////////////////////////////////////////////////////////////
void
LineRoute::update(MysqlConnection& mysql, const DbLine& line)
{
  using namespace sqlpp;
  tables::Contents contents;
  ...
  mysql.db()(remove_from(contents).where(contents.bookid == line.bookid and
                                         ...
                                         contents.lineid == line.lineid));
  // add new contents
  auto stmnt = mysql.db().prepare(
    insert_into(contents).set(contents.bookid = line.bookid,
                              contents.pageid = line.pageid,
                              contents.lineid = line.lineid,
