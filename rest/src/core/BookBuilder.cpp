...
////////////////////////////////////////////////////////////////////////////////
BookBuilder::BookBuilder() : book_(), pages_() { reset(); }
...
////////////////////////////////////////////////////////////////////////////////
const BookBuilder &BookBuilder::set_owner(int owner) const {
  assert(book_);
...
////////////////////////////////////////////////////////////////////////////////
bool BookBuilder::has_unique_page_ids() const {
  std::set<int> ids;
...
////////////////////////////////////////////////////////////////////////////////
void BookBuilder::reorder_pages() const {
  // skip empty books
  if (pages_.empty())
    return;
