// ================================
// apps/projects/a_pocoto/train_postcorrection/show/show_view.js
// ================================
...
define(["marionette","app","jquery-ui","backbone.syphon","common/views","apps/projects/page/show/show_view","apps/projects/concordance/show/show_view",
        "tpl!apps/projects/a_pocoto/train_postcorrection/show/templates/info.tpl",
  ...
  Show.TrainPostcorrection = Marionette.View.extend({
      template: infoTpl,
      events:{
