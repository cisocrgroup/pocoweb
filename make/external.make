...
ext/mysqlpp11/Makefile ext/mysqlpp11/CMakeCache.txt: $(MODS) | mkdir-ext-mysqlpp11
	$(call ECHO,$@)
	$V cd ext/mysqlpp11 && cmake -DCMAKE_EXE_LINKER_FLAGS="" -DCMAKE_CXX_COMPILER=$(CXX) -DCMAKE_CXX_FLAGS=$(CXXFLAGS) -DCMAKE_CXX_FLAGS=-fpic ../../modules/sqlpp11-connector-mysql/
