...
////////////////////////////////////////////////////////////////////////////////
void UpdateUser::Register(App& app) {
	CROW_ROUTE(app, UPDATE_USER_ROUTE)(*this);
}

////////////////////////////////////////////////////////////////////////////////
crow::response UpdateUser::operator()(const crow::request& request,
				      const std::string& name,
				      const std::string& key,
				      const std::string& val) const {
	// get user
	LockedSession session(must_find_session(request));
...
////////////////////////////////////////////////////////////////////////////////
void UpdateUser::update(User& user, const std::string& key,
