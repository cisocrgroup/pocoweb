...
namespace tables
{
  ...
  namespace Suggestions_
  {
    ...
    struct Suggestiontypid
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "suggestiontypid";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T suggestiontypid;
            T& operator()() { return suggestiontypid; }
            const T& operator()() const { return suggestiontypid; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::integer, sqlpp::tag::can_be_null>;
    };
  ...
  namespace Typcounts_
  {
    ...
    struct Counts
    {
      struct _alias_t
      {
        static constexpr const char _literal[] =  "counts";
        using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
        template<typename T>
        struct _member_t
          {
            T counts;
            T& operator()() { return counts; }
            const T& operator()() const { return counts; }
          };
      };
      using _traits = sqlpp::make_traits<sqlpp::integer, sqlpp::tag::require_insert>;
    };
               ...
               Typcounts_::Counts>
  {
    struct _alias_t
    {
      static constexpr const char _literal[] =  "typcounts";
      using _name_t = sqlpp::make_char_sequence<sizeof(_literal), _literal>;
      template<typename T>
      struct _member_t
      {
        T typcounts;
        T& operator()() { return typcounts; }
        const T& operator()() const { return typcounts; }
      };
    };
  };
