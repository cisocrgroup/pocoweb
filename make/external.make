...
ext/mysqlpp11/Makefile ext/mysqlpp11/CMakeCache.txt: $(MODS) | mkdir-ext-mysqlpp11
	$(call ECHO,$@)
	$V cd ext/mysqlpp11 && cmake -DCMAKE_CXX_COMPILER=$(CXX) -DCMAKE_LIBCPP_VERSION=c++-14 -DCMAKE_CXX_FLAGS=$CXXFLAGS -DCMAKE_CXX_FLAGS=-fpic ../../modules/sqlpp11-connector-mysql/
