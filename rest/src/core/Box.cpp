...
#define SWAP_HORIZONTAL() \
	if (right_ < left_) std::swap(right_, left_)
...
///////////////////////////////////////////////////////////////////////////////
void Box::set_left(int l) noexcept {
	left_ = std::max(0, l);
	SWAP_HORIZONTAL();
	POSTCONDITION();
}
...
///////////////////////////////////////////////////////////////////////////////
void Box::set_top(int t) noexcept {
	top_ = std::max(0, t);
	SWAP_VERTICAL();
	POSTCONDITION();
}
...
///////////////////////////////////////////////////////////////////////////////
void Box::set_right(int r) noexcept {
	right_ = std::max(0, r);
	SWAP_HORIZONTAL();
	POSTCONDITION();
}
...
///////////////////////////////////////////////////////////////////////////////
void Box::set_bottom(int b) noexcept {
	bottom_ = std::max(0, b);
	SWAP_VERTICAL();
	POSTCONDITION();
}
...
///////////////////////////////////////////////////////////////////////////////
Box& Box::increase_right(int d) noexcept {
...
///////////////////////////////////////////////////////////////////////////////
Box& Box::increase_top(int d) noexcept {
...
///////////////////////////////////////////////////////////////////////////////
Box& Box::increase_bottom(int d) noexcept {
...
///////////////////////////////////////////////////////////////////////////////
Box& Box::increase(int d) noexcept {
	return increase_left(d)
	    .increase_right(d)
	    .increase_top(d)
	    .increase_bottom(d);
}
...
///////////////////////////////////////////////////////////////////////////////
std::vector<Box> Box::split(int n) const {
