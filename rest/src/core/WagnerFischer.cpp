...
WagnerFischer::set_gt(const std::wregex& pat, const std::wstring& repl)
{
  if (gt_.empty()) {
    std::regex_replace(
      std::back_inserter(gt_), begin(ocr_), end(ocr_), pat, repl.data());
  } else {
    std::wstring tmp = gt_;
    gt_.clear();
    std::regex_replace(
      std::back_inserter(gt_), begin(tmp), end(tmp), pat, repl.data());
  }
}
...
////////////////////////////////////////////////////////////////////////////////
size_t
WagnerFischer::operator()(size_t b, size_t n)
{
...
////////////////////////////////////////////////////////////////////////////////
size_t
pcw::WagnerFischer::find_begin_of_token(Trace::const_iterator b,
...
////////////////////////////////////////////////////////////////////////////////
size_t
pcw::WagnerFischer::find_end_of_token(Trace::const_iterator i,
