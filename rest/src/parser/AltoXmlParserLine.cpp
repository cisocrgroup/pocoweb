...
////////////////////////////////////////////////////////////////////////////////
LinePtr AltoXmlParserLine::line(int id) const {
...
////////////////////////////////////////////////////////////////////////////////
std::wstring AltoXmlParserLine::wstring() const {
	std::wstring res(chars_.size(), 0);
	std::transform(begin(chars_), end(chars_), begin(res),
		       [](const auto& c) { return c.c; });
	return res;
}

////////////////////////////////////////////////////////////////////////////////
std::string AltoXmlParserLine::string() const {
	std::string res;
...
////////////////////////////////////////////////////////////////////////////////
void AltoXmlParserLine::end_wagner_fischer() {
	if (not needs_update_) return;
...
////////////////////////////////////////////////////////////////////////////////
void AltoXmlParserLine::update_space(Iterator i, Node& parent) {
...
////////////////////////////////////////////////////////////////////////////////
void AltoXmlParserLine::update_hyphen(Iterator i, Node& parent) {
...
////////////////////////////////////////////////////////////////////////////////
void AltoXmlParserLine::update_char(Iterator b, Iterator e, Node& parent) {
	assert(b != e);
	Node node;
	if (not b->node) {
...
////////////////////////////////////////////////////////////////////////////////
void AltoXmlParserLine::insert(size_t pos, wchar_t c) {
...
////////////////////////////////////////////////////////////////////////////////
void AltoXmlParserLine::erase(size_t pos) {
...
////////////////////////////////////////////////////////////////////////////////
void AltoXmlParserLine::set(size_t pos, wchar_t c) {
...
////////////////////////////////////////////////////////////////////////////////
void AltoXmlParserLine::init_string(const pugi::xml_node& node) {
...
////////////////////////////////////////////////////////////////////////////////
void AltoXmlParserLine::init_space(const Node& node) {
...
////////////////////////////////////////////////////////////////////////////////
void AltoXmlParserLine::init_hyphen(const Node& node) {
...
////////////////////////////////////////////////////////////////////////////////
Box AltoXmlParserLine::get_box(const Node& node) {
...
////////////////////////////////////////////////////////////////////////////////
void AltoXmlParserLine::set_box(const Box& box, Node& node) {
	if (not node.attribute("HPOS")) node.append_attribute("HPOS");
	if (not node.attribute("VPOS")) node.append_attribute("VPOS");
	if (not node.attribute("WIDTH")) node.append_attribute("WIDTH");
	if (not node.attribute("HEIGHT")) node.append_attribute("HEIGHT");
...
////////////////////////////////////////////////////////////////////////////////
void AltoXmlParserLine::set_conf(double conf, Node& node) {
	if (not node.attribute("WC")) node.append_attribute("WC");
	node.attribute("WC").set_value(conf);
}

////////////////////////////////////////////////////////////////////////////////
void AltoXmlParserLine::set_content(const std::wstring& str, Node& node) {
	if (not node.attribute("CONTENT")) node.append_attribute("CONTENT");
	std::string ustr;
...
////////////////////////////////////////////////////////////////////////////////
AltoXmlParserLine::Iterator AltoXmlParserLine::find_end_of_token(
    Iterator b, Iterator e) noexcept {
	assert(b != e);
	switch (b->type) {
		case Type::Char:
...
////////////////////////////////////////////////////////////////////////////////
AltoXmlParserLine::Char AltoXmlParserLine::make_copy(Char& c) {
...
////////////////////////////////////////////////////////////////////////////////
AltoXmlParserLine::Node AltoXmlParserLine::merge(Node& a, const Node& b) {
...
////////////////////////////////////////////////////////////////////////////////
bool AltoXmlParserLine::is_space(const Node& node) noexcept {
	return strcmp(node.name(), "SP") == 0;
}

////////////////////////////////////////////////////////////////////////////////
bool AltoXmlParserLine::is_hyphen(const Node& node) noexcept {
	return strcmp(node.name(), "HYP") == 0;
}

////////////////////////////////////////////////////////////////////////////////
bool AltoXmlParserLine::is_string(const Node& node) noexcept {
